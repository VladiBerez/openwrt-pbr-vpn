...
# --- Meta / Instagram / Facebook / WhatsApp (well-known prefixes) ---
nft add element inet fw4 $S "{ 31.13.0.0/16, 66.220.0.0/16, 69.63.0.0/16, 69.171.0.0/16, 74.119.0.0/16, 102.132.0.0/16, 102.221.0.0/16, 103.4.0.0/16, 129.134.0.0/16, 157.240.0.0/16, 163.70.0.0/16, 163.77.128.0/17, 163.114.0.0/16, 173.252.0.0/16, 179.60.0.0/16, 185.60.0.0/16, 185.60.212.0/22, 185.89.0.0/16 }" 2>/dev/null

...
def _clean_env(monkeypatch):
    ...
    for k in (
        ...
        "ROUTER_SSH_KEY", "VPN_INTERFACE", "REMOTE_ROUTES_PATH",
        "LOCAL_ROUTES_PATH", "DOMAINS_PATH", "BACKUPS_DIR",
    ):
...
def test_raises_when_no_credentials(monkeypatch, tmp_path):
    ...
    with mock.patch.object(config, "_resolve_password", return_value=None):
